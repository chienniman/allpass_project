...
<body>
        ...
        <div class="box-inner">
          <div class="Remark">
            <div>
              ...
              <div style="color:#f95223; font-size: 12px;font-weight: 600;padding-top:0.5rem; text-align: center;">
                ※學生特惠餐限興大學生憑學生證選用<br>一證一套。</div>
              <div style="color:black; font-size: 20px;font-weight: 600;padding-top:0.5rem;">6.日式咖哩－11：00～19：30</div>
              <div style="color:#f95223; font-size: 12px;font-weight: 600;padding-top:0.5rem; text-align: center;">
                ※升級套餐可享有濃湯與手工麵包一份</div>
  ...
  <script src="../js/mealsindex.js"></script>
  <!-- 本網頁使用圖片來源與作者 -->
